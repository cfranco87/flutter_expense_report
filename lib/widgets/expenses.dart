...
class _ExpensesState extends State<Expenses> {
  ...
  void _removeExpense(Expense expense) {
    //func to remove item from list internally, remove memory
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: width < 600
          ? Column(
              //landscape mode for phone if available space is more than 600
              children: [
          ...
          : Row(
              //switch to row depending on width available
              children: [
                Expanded(
